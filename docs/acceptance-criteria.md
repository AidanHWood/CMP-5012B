...
- Given Kieran is logging a food item
...
- Given Leonard has logged data over multiple days
- When he views his progress over time
- Then the system displays clear trends showing changes across that period
...
- Given Olivia is logged in and connected with friends
